          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                 Rekhta Academy Pakistan was established with a singular vision: to provide quality education, purposeful guidance, and a supportive learning community for students.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
             <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4 text-foreground">Why Choose Rekhta Academy?</h2>
