          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                 At Rekhta Academy Pakistan, we believe that education is more than just passing exams. It's about developing character, instilling values, and preparing students for the challenges of tomorrow.
              </p>
              <p className="text-muted-foreground leading-relaxed text-lg">
