    ...
    <div className="w-full bg-background pt-20">
      ...
      <div className="bg-primary text-white py-16 text-center border-b-[6px] border-accent">
        <div className="container mx-auto px-4">
          ...
          >
             Secure your child's future at Rekhta Academy Pakistan. Admissions are open for the next learning session.
          </motion.p>
        </div>
      </div>
            ...
            <div className="md:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                   The admission process at Rekhta Academy is straightforward. You can apply via WhatsApp, visit our campus, or fill out the inquiry form.
                </p>
