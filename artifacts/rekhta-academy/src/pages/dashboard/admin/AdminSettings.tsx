...
export function AdminSettings() {
  ...
  const [academy, setAcademy] = useState({ academy_name: 'Rekhta Academy Pakistan', email: 'rekhtaacademypakistan@gmail.com', phone: '+92 304 3333418', timings: 'Open 24 hours', address: '2 6th Road, Block F, New Katarian Satellite Town, Rawalpindi, 46000, Pakistan', instagram: '', tiktok: '', youtube: '' });
