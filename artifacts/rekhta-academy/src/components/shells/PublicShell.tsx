...
import logo from '@assets/rekhta-academy-logo.png';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3">
              <img src={logo} alt="Rekhta Academy Pakistan" className="h-12 w-12 rounded-full object-cover border-2 border-accent" />
              <div>
                <h1 className="font-serif font-bold text-xl md:text-2xl text-primary leading-tight">Rekhta Academy Pakistan</h1>
                <p className="text-[10px] md:text-xs text-muted-foreground uppercase tracking-widest font-semibold">We Will Shine Together</p>
              </div>
            </Link>
      ...
      <footer className="bg-primary text-primary-foreground pt-16 pb-8 border-t-[6px] border-accent">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-serif font-bold text-2xl">Rekhta Academy Pakistan</h2>
              </div>
              <p className="text-primary-foreground/80 mb-6 text-sm leading-relaxed max-w-sm">
                 A trusted, community-rooted institution in Rawalpindi serving students from primary to higher secondary levels. We will shine together through learning and character.
              </p>
            </div>
          ...
          <div className="border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-primary-foreground/60">
             <p>&copy; {new Date().getFullYear()} Rekhta Academy Pakistan. All rights reserved.</p>
